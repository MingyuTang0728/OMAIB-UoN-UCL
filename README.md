...
1. Enable Pages: Settings → Pages → Build and deployment → Source: `Deploy from a branch` ; Branch: `main` ; Folder: `/ (root)` 
2. Your site will be served at:

```
https://mingyutang0728.github.io/OMAIB-UoN-UCL/
```
...
> File names are case‑sensitive on GitHub Pages. If you rename or move assets (e.g., into `assets/`), update the query params accordingly.
